...
MODULE postprocess
   ...
   SUBROUTINE CHECKS
      ...
      INTEGER, ALLOCATABLE, DIMENSION(:) :: TOT_NUM_RECV
      INTEGER(KIND=8), ALLOCATABLE, DIMENSION(:) :: TOT_REACT_COUNTS
      INTEGER(KIND=8), ALLOCATABLE, DIMENSION(:) :: TOT_REACT_COUNTS_RECV
      ...
      ! Use per-rank cumulative counters; MPI reduction below produces global totals.
      DO JR = 1, N_REACTIONS
         TOT_REACT_COUNTS(JR) = REACTIONS(JR)%COUNTS_CUM
      END DO
      ...
      IF (PROC_ID .EQ. 0) THEN
         ...
         CALL MPI_REDUCE(MPI_IN_PLACE, TOT_REACT_COUNTS, N_REACTIONS, MPI_INTEGER8, MPI_SUM, 0, MPI_COMM_WORLD, ierr)
      ...
      ELSE
         ...
         CALL MPI_REDUCE(FIELD_POWER, FIELD_POWER_TOT, 1, MPI_DOUBLE_PRECISION, MPI_SUM, 0, MPI_COMM_WORLD, ierr)
         CALL MPI_REDUCE(TOT_REACT_COUNTS, TOT_REACT_COUNTS_RECV, N_REACTIONS, MPI_INTEGER8, MPI_SUM, 0, MPI_COMM_WORLD, ierr)
